...
if __name__ == "__main__":
    # ====== 路径（按需替换）======
    res_path = 'data/llm_infer_res/ours_chunggeng_tts.jsonl'
    claude_jsonl = "data/llm_infer_res/claude_chunggeng.jsonl"
    ds_jsonl     = "data/llm_infer_res/ds_chunggeng.jsonl"
    gemini_jsonl = "data/llm_infer_res/gemini_chunggeng.jsonl"
    gpt4o_jsonl  = "data/llm_infer_res/gpt4o_chunggeng.jsonl"
    gpt5_jsonl   = "data/llm_infer_res/gpt5_chunggeng.jsonl"
