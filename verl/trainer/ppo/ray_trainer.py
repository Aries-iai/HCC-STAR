    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                if "a_rewards" in batch.batch and "b_rewards" in batch.batch:
                    metrics.update({
                        "reward/treatment_mean": batch.batch["a_rewards"].mean().item(),
                        "reward/survival_mean": batch.batch["b_rewards"].mean().item(),
                    })
